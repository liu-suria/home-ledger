...
6. `settings-ui.js` — statistics, settings, import/export, theme and type management.
7. `templates-ui.js` — built-in and personal template management.
8. `recurring-rules-ui.js` — recurring definition editor under Settings.
9. `event-assets-ui.js` — attachment and logo interactions plus incremental list loading.
